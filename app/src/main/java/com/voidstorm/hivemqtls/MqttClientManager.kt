...
class MqttClientManager(private val context: Context) {
    companion object {
        ...
        private const val MQTT_BROKER_HOST = "192.168.1.2" // Your Mosquitto broker IP
    ...
    private var messageCallback: ((CrashAlert) -> Unit)? = null
     ...
     */
    private fun processMessage(publish: Mqtt3Publish) {
        try {
     ...
     */
    fun setMessageCallback(callback: (CrashAlert) -> Unit) {
