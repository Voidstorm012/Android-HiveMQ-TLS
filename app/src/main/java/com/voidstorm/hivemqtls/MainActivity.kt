...
import com.voidstorm.hivemqtls.ui.theme.MQTTTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onDestroy() {
        super.onDestroy()
        // Disconnect MQTT client when activity is destroyed
        mqttClientManager.disconnect()
    }
}

@Composable
fun MqttScreen(mqttClientManager: MqttClientManager) {
    ...
    DisposableEffect(mqttClientManager) {
        // Set message callback
        mqttClientManager.setMessageCallback { alert ->
        ...
        mqttClientManager.setConnectionCallback { isConnected ->
...
@Composable
fun CrashAlertDetails(crashAlert: CrashAlert) {
    Column(
        modifier = Modifier.fillMaxWidth(),
